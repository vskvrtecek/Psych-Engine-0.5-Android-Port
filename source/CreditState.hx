...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['vs kubiiik'],
			['kubiiicek123',		    'kubiiik',		    'creator of the mod',	 'https://youtube.com/channel/UCRCTEBzTL_dw1rLve40hnZg',	    'F73838'],
			['kadamcz',		        'kada',		    'made the triple trouble sprites',	                 'https://youtube.com/channel/UCB_lTh0x_GW4FC80vrrDUqg',	    '261EA9'],		
			['serebeat',               'serebeat',            'made the bullet note thingy',                    'https://youtube.com/c/SereBeat',           '53E52C'],				
			[''],
			['Psych Engine Team'],
